...
# https://grouplens.org/datasets/movielens/ 這是一个关于电影评价数据集的网站
# 该程序主要是反映基于用户的推荐算。
# 基于python2.x的，关于3.x程序对于数据的解码方面有问题。
#
...
if __name__ == '__main__':
    ...
    movies = getMoviesList("C:\\Users\\xibol\\Downloads\\ml-100k\\u.item")
    recommend_list, user_movie, items_movie, neighbors = recommendByUserFC(
        "C:\\Users\\xibol\\Downloads\\ml-100k\\u.data",
        179, 80)
